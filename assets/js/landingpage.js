(function ($) {
  ...
  // Date Picker
  if ($(".landingpage-datepicker").length) {
    $(".landingpage-datepicker").each(function () {
      $(this).datepicker();
    });
  }

  // jarallax
  $('.landingpage-jarallax').jarallax({});
  ...
  //accordion
  if ($(".landingpage-accordion").length) {
    var accordionGrp = $(".landingpage-accordion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".landingpage-accordion." + accordionName)
                .find(".accordion")
                .removeClass("active");
              $(".landingpage-accordion." + accordionName)
                .find(".accordion")
  ...
  function thmOwlInit() {
    // owl slider
    let landingpageowlCarousel = $(".landingpage-owl__carousel");
    if (landingpageowlCarousel.length) {
      landingpageowlCarousel.each(function () {
        let elm = $(this);
    ...
    let landingpageowlCarouselNav = $(".landingpage-owl__carousel--custom-nav");
    if (landingpageowlCarouselNav.length) {
      landingpageowlCarouselNav.each(function () {
        let elm = $(this);
  ...
  //Strech Column
  function landingpage_stretch() {
    var i = $(window).width();
    $(".row .landingpage-stretch-element-inside-column").each(function () {
      var $this = $(this),
  ...
  function landingpage_cuved_circle() {
